...
@section('content')
    ...
    {{-- じゅんちゃんねるの簡単な紹介 --}}
    <div class="h3 mt-5 mb-5 ml-5 mr-5">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title font-weight-bold mb-4"><span>じゅんちゃんねるについて</span></h3>
                <h5 class="card-text mb-3">じゅんちゃんねるは某有名掲示板を真似た匿名掲示板です。<br>スレッドでのコメントを通じて趣味が合う者同士（雑談でも何でもOK）の楽しい交流の場として利用していただけると管理人としても嬉しいです。<br>基本的にお好きにご利用いただいて構いませんが、最低限のマナーを守って利用しましょう！</h4>
            </div>
        </div>
    </div>
